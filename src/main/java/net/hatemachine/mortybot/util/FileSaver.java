/*
 * The following class was lifted from darwinsys-api (https://github.com/IanDarwin/darwinsys-api)
 * and was written by Ian Darwin (https://github.com/IanDarwin).
 * See LICENSE.darwinsys.txt for original license.
 *  -bmw
 */
